...
public class BinarySpacePartitioner
{
    ...
    {
        this.rootNode = new RoomNode(new Vector2Int(0, 0), new Vector2Int(dungeonWidth, dungeonLength), null, 0 , 1);
    }
    ...
    public List<RoomNode> PrepareNodesCollection(int maxIterations, int roomWidthMin, int roomLengthMin)
    {
        ...
        while (iterations<maxIterations && graph.Count>0)
        {
            ...
            {
                SplitTheSpace(currentNode, listToReturn, roomLengthMin, roomWidthMin, graph,newMinID);
                newMinID = newMinID + 2;
            }
    ...
    private void SplitTheSpace(RoomNode currentNode, List<RoomNode> listToReturn, int roomLengthMin, int roomWidthMin, Queue<RoomNode> graph,int newMinID)
    {
